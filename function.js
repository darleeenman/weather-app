...
function getForecast(coordinates) {
  ...
  let apiByLatLon = `https:api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&apiid=${apiKey}&units=metric`;
  axios.get(apiByLatLon).then(displayForecast);
}
...
function searchCity(city) {
  let apiByCity = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${apiKey}&units=metric`;
